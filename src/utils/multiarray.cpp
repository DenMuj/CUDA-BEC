 ...
 * @tparam T Data type
 */
template <typename T> MultiArray<T>::MultiArray() : dim1(0), dim2(0), dim3(0) {}
 ...
 */
template <typename T> MultiArray<T>::MultiArray(size_t n1) : data(n1), dim1(n1), dim2(1), dim3(1) {}
 ...
 */
template <typename T>
MultiArray<T>::MultiArray(size_t n1, size_t n2) : data(n1 * n2), dim1(n1), dim2(n2), dim3(1) {}
 ...
 * @param n1 Size of the 1D array
 */
template <typename T> void MultiArray<T>::resize(size_t n1) {
    data.resize(n1);
    dim1 = n1;
    dim2 = 1;
    dim3 = 1;
 ...
 * @param n2 Size of the 2D array
 */
template <typename T> void MultiArray<T>::resize(size_t n1, size_t n2) {
    data.resize(n1 * n2);
    dim1 = n1;
    dim2 = n2;
    dim3 = 1;
 ...
 * @param n3 Size of the 3D array
 */
template <typename T> void MultiArray<T>::resize(size_t n1, size_t n2, size_t n3) {
 ...
 */
template <typename T> T &MultiArray<T>::at(size_t i) {
    if (i >= dim1)
 ...
 * @param i Index of the 1D array
 */
template <typename T> T &MultiArray<T>::operator[](size_t i) { return data[i]; }
template <typename T> const T &MultiArray<T>::operator[](size_t i) const { return data[i]; }
 ...
 */
template <typename T> T &MultiArray<T>::at(size_t i, size_t j) {
    if (i >= dim1 || j >= dim2)
 ...
 * @param j Index of the 2D array
 */
template <typename T> T &MultiArray<T>::operator()(size_t i, size_t j) {
    return data[i * dim2 + j];
}
template <typename T> const T &MultiArray<T>::operator()(size_t i, size_t j) const {
    return data[i * dim2 + j];
}
 ...
 */
template <typename T> T &MultiArray<T>::at(size_t i, size_t j, size_t k) {
 ...
 * @param k Index of the 3D array
 */
template <typename T> T &MultiArray<T>::operator()(size_t i, size_t j, size_t k) {
    return data[(i * dim2 + j) * dim3 + k];
}
template <typename T> const T &MultiArray<T>::operator()(size_t i, size_t j, size_t k) const {
    return data[(i * dim2 + j) * dim3 + k];
}
 ...
 * @tparam T Data type
 */
template <typename T> T *MultiArray<T>::raw() { return data.data(); }
template <typename T> const T *MultiArray<T>::raw() const { return data.data(); }

/**
 * @brief Get the size of the MultiArray
 * @tparam T Data type
 */
template <typename T> size_t MultiArray<T>::size() const { return data.size(); }
